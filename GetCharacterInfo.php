...
/*
	HentaiVN.tv API by Nico Levianth - Getting character info
	v1.0
...
if ($_GET["name"])
{
    ...
    $html = file_get_contents("https://hentaivn.tv/char=" . $_GET["name"] . ".html" . $page);
	// Create objects
    $doc = new DomDocument();
    $info = new stdClass();
    $doc->loadHTML($html);
    ...
    if ($info->display_name == null) echo '{"error": "Character is invalid"}';
    else
    {
...
{
    echo '{"error": "Character Name is invalid"}';
}
?>
